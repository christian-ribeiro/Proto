...
public class InputCreateProduct(string code, string description, string? barCode, decimal costValue, decimal saleValue, EnumStatus status, decimal weight, decimal netWeight, string? observation, long brandId) : BaseInputCreate<InputCreateProduct>
{
