...
public class InputUpdateProduct(string description, string? barCode, decimal costValue, decimal saleValue, EnumStatus status, decimal weight, decimal netWeight, string? observation, long brandId, long? productCategoryId) : BaseInputUpdate<InputUpdateProduct>
{
